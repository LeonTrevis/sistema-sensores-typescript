...
const medicao3 = criarMedicao(3, sensorMotorA, 130, new Date());
const medicao4 = criarMedicao(4, sensorMotorA, 30, new Date());
const medicao5 = criarMedicao(5, sensorMotorA, 200, new Date());
